...
export default function AudienceInsights({ reportId = 'b1' }) {
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <div className="overflow-x-auto">
            <div className="grid grid-cols-25 gap-[2px] min-w-[500px]" style={{ gridTemplateColumns: 'repeat(25, minmax(0, 1fr))' }}>
              <div className="text-[8px] text-[--text-muted]" />
              {Array.from({ length: 24 }).map((_, h) => (
                <div key={h} className="text-[8px] text-[--text-muted] text-center font-mono">
                  {h}
                </div>
              ))}
              {audience.peakEngagement.slice(0, 168).map((cell, i) => (
                <div
                  ...
                  style={{
                    backgroundColor: `rgba(0, 212, 170, ${cell.intensity / 100})`,
                  }}
            ...
            <div className="mt-2 flex items-center gap-2 text-[10px] text-[--text-muted] font-body">
              ...
              <div className="flex gap-[1px]">
                {[0.15, 0.3, 0.5, 0.7, 0.9].map((o) => (
                  <div key={o} className="w-3 h-3 rounded-sm" style={{ backgroundColor: `rgba(0, 212, 170, ${o})` }} />
                ))}
              </div>
              <span>High</span>
